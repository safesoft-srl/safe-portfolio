...
export function SkillCard({ 
  ...
  return (
    <Card className={`relative flex flex-col bg-[#13152e] border ${isActive ? 'border-[#232555] hover:border-[#6c72ff]/50' : 'border-red-900/50 opacity-80'} rounded-2xl overflow-hidden shadow-2xl transition-all group h-full`}>
            ...
            <AlertDialogContent className="bg-[#13152e] border border-[#232555]">
              <AlertDialogHeader>
                ...
                <AlertDialogDescription className="text-slate-400">
                  Se eliminará permanentemente la habilidad <b className="text-white">{skillName}</b> de tu portafolio.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
      ...
      <CardContent className="p-6 flex flex-col items-center text-center flex-grow">
        <div className={`w-16 h-16 rounded-2xl mb-4 flex items-center justify-center bg-[#1c1f38] border ${isActive ? 'border-[#232555]' : 'border-red-900/50'} shadow-inner`}>
          {skillIcon ? (
            <img
              src={skillIcon}
              alt={skillName}
            ...
            <span className={`font-bold text-2xl ${isActive ? 'text-[#6c72ff]' : 'text-slate-600'}`}>
              {skillName.charAt(0)}
            </span>
          )}
        </div>
