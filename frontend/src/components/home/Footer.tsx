export default function Footer() {
  ...
  return (
    <footer id="footer" className="relative mt-12 overflow-hidden border-t border-white/10 bg-transparent text-slate-200">
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-[2fr_0.5fr_0.7fr_0.7fr] lg:gap-16">
          <div className="max-w-xl">
            ...
            <p className="mt-6 max-w-2xl text-sm leading-6 text-slate-300/90">
              Potenciamos tu marca personal a través de portafolios digitales optimizados.
              Ayudamos a creadores, desarrolladores y agencias a estructurar sus mejores
              proyectos con diseños listos para convertir visitas en grandes oportunidades.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-sm font-bold tracking-[-0.02em] text-white">
              Empresa
            </h3>
