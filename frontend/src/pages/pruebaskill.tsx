...
export default function PruebaSkill() {
  ...
  const [dummySoftSkill, setDummySoftSkill] = useState<SoftSkill>({
    ...
    description:
      "Capacidad para guiar equipos multidisciplinarios hacia objetivos comunes, fomentando un ambiente de colaboración y crecimiento continuo.",
  });
  ...
  return (
    <div className="min-h-screen bg-[#14162f] flex flex-col items-center justify-center p-10 font-heading">
      ...
      <div className="w-full max-w-sm h-64">
        <SoftSkillCard skill={dummySoftSkill} onEdit={handleEditOpen} onDelete={handleDelete} />
      </div>
      ...
      <div className="mt-12 p-6 bg-[#13152e] border border-[#232555] rounded-xl text-slate-400 text-sm w-full max-w-md">
        ...
        <ul className="list-disc pl-5 mt-2 space-y-2">
          <li>
            Pasa el mouse: Los botones de lápiz y basura deben aparecer en la esquina superior
            derecha.
          </li>
          <li>
            <b>Eliminar:</b> Haz clic en la basura y verifica que el AlertDialog aparezca con el
            formato oscuro.
          </li>
          <li>
            <b>Editar:</b> Haz clic en el lápiz. El modal debe abrirse precargado con el nombre y
            descripción.
          </li>
          <li>
            <b>Validación:</b> Modifica el texto y fíjate en el contador de caracteres (45 y 255).
          </li>
          <li>
            <b>Guardar:</b> Haz clic en Guardar y observa el estado de carga antes de que se
            actualice la tarjeta.
          </li>
        </ul>
      </div>
