...
import { Globe, MagnifyingGlass, FunnelSimple } from "@phosphor-icons/react";
...
// DATOS FALSOS TEMPORALES PARA EL CATÁLOGO
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-[#232555] pb-6">
            <div className="space-y-2">
              ...
              <p className="text-slate-400 text-sm md:text-base max-w-2xl">
                Explora portafolios de profesionales talentosos. Filtra por tecnologías o roles específicos para encontrar exactamente lo que buscas.
              </p>
            </div>
          </div>
