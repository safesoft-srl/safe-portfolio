    ...
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-8">
      ...
      <div className="mb-2">
        ...
        <p className="mt-2 text-slate-400">
          Este es el panel de control de tu portafolio como <span className="font-semibold text-white">{portfolioData?.profession || "Profesional"}</span>.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          <div className="flex flex-col h-full justify-between relative z-10">
            ...
            <div className="mt-8">
              <div className="flex justify-between items-end mb-2">
                ...
                <span className="text-xs font-medium text-[#6c72ff] uppercase tracking-wider">Completado</span>
              </div>
        ...
        <div className="col-span-1 md:col-span-1 lg:col-span-2 grid grid-cols-2 gap-4">
          ...
          <div className="rounded-2xl border border-[#2a2f55] bg-[#14172b]/60 p-5 backdrop-blur-sm transition-colors hover:bg-[#1a1e36]">
            ...
            <p className="text-3xl font-bold text-white">{portfolioData?.work_experiences_count || 0}</p>
          </div>
          ...
          <div className="rounded-2xl border border-[#2a2f55] bg-[#14172b]/60 p-5 backdrop-blur-sm transition-colors hover:bg-[#1a1e36]">
            ...
            <p className="text-3xl font-bold text-white">
              {(portfolioData?.portfolio_skills_count || 0) + (portfolioData?.soft_skills_count || 0)}
            </p>
          </div>
        ...
        <div className="col-span-1 md:col-span-3 lg:col-span-2 rounded-2xl border border-[#2a2f55] bg-[#14172b]/60 p-6 backdrop-blur-sm">
          ...
          <div className="flex flex-col gap-3">
            <Link to={`/dashboard/${idPortfolio}/profile`} className="group flex items-center justify-between rounded-xl bg-[#0f1224] p-3 border border-[#2a2f55] transition-all hover:border-[#6c72ff]/50 hover:bg-[#1a1e36]">
            ...
            <Link to={`/dashboard/${idPortfolio}/projects`} className="group flex items-center justify-between rounded-xl bg-[#0f1224] p-3 border border-[#2a2f55] transition-all hover:border-[#6c72ff]/50 hover:bg-[#1a1e36]">
              <div className="flex items-center gap-3 text-slate-300 group-hover:text-white">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#2a2f55] text-[#6c72ff] group-hover:bg-[#6c72ff] group-hover:text-white transition-colors">
            ...
            <Link to={`/dashboard/${idPortfolio}/experience`} className="group flex items-center justify-between rounded-xl bg-[#0f1224] p-3 border border-[#2a2f55] transition-all hover:border-[#6c72ff]/50 hover:bg-[#1a1e36]">
              <div className="flex items-center gap-3 text-slate-300 group-hover:text-white">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#2a2f55] text-[#6c72ff] group-hover:bg-[#6c72ff] group-hover:text-white transition-colors">
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            <div>
              ...
              <p className="text-sm text-slate-400 mb-6">
                Genera una URL única para compartir tu perfil profesional con reclutadores y empresas.
              </p>

              <div className="space-y-4">
                <div className="relative w-full">
                  <span className="text-xs font-sans text-slate-400 mb-1 block">URL personalizada:</span>
            ...
            {portfolioUrl && (
              <div className="mt-6 border-t border-[#2a2f55] pt-4">
                <span className="text-xs font-sans text-slate-400 block mb-2">Tu enlace público activo:</span>
